...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{URL::asset('/themes/adminlte/plugins/iCheck/square/blue.css')}}">
...
<div class="register-box">
    <div class="register-logo">
        <a href="@yield('website_url')"><b>@yield('website_name_first_part')</b>@yield('website_name_second_part') <i class="@yield('icon')"></i></a>
    </div>
...
<!-- iCheck -->
<script src="{{URL::asset('/themes/adminlte/plugins/iCheck/icheck.min.js')}}"></script>
<script>
    $(function () {
        $('input').iCheck({
