        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                <ul class="nav navbar-nav">
                  <?php $loopRuns = 0 ?>
                  @while(true)
                    <li @if(Request::is($websitePagesList[$loopRuns]->page_url)) class="active" @endif><a href="{{$websitePagesList[$loopRuns]->page_url}}">{{$websitePagesList[$loopRuns]->page_title}} @if(Request::is($websitePagesList[$loopRuns]->page_url)) <span class="sr-only">(current)</span> @endif</a></li>
                    <?php $loopRuns++ ?>
